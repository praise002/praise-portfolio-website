...
module.exports = {
    content: ["./src/**/*.{html,js}", "./assets/**/*.{html,js,css}"],
    theme: {
        extend: {
            fontFamily: {
            ...
            keyframes: {
                ...
                "flipy-top-left": {
                    "0%": {
                        transform:
                            "translate3d(-100%, -100%, 0) rotateX(-180deg)",
                    },
                    "50%": {
                        transform: "rotateX(-90deg) ",
                    },
                ...
                "zoom-in-up": {
                    "0%": {
                        opacity: 0,
                        transform:
                            "scale3d(0.3, 0.3, 0.3) translate3d(0, 100%, 0)",
                    },
                    "80%": {
                        opacity: 0.8,
                        transform: "scale3d(1.1, 1.1, 1.1)",
                ...
                "zoom-in-right": {
                    "0%": {
                        opacity: 0,
                        transform:
                            "scale3d(0.3, 0.3, 0.3) translate3d(-100%, 0, 0)",
                    },
                    "80%": {
                        opacity: 0.8,
                        transform: "scale3d(1.1, 1.1, 1.1)",
                ...
                "zoom-in-bottom-right": {
                    "0%": {
                        opacity: 0,
                        transform:
                            "scale3d(0.3, 0.3, 0.3) translate3d(100%, 100%, 0)",
                    },
                    "80%": {
                        opacity: 0.8,
                        transform: "scale3d(1.1, 1.1, 1.1)",
            ...
            animation: {
                ...
                fadeinbounceright:
                    "fade-in-bounce-right 1s ease-in-out 0.25s 1",
